...
assert.match(notificationsView, /<div class="overflow-x-auto(?:\s+[^>]*)?>/, 'notification tabs must be allowed to scroll horizontally')
assert.match(notificationsView, /<div class="flex min-w-max gap-2"(?:\s+[^>]*)?>/, 'notification tabs must keep stable inline sizing')
