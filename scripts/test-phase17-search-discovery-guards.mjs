...
has(searchView, /<details class="filter-details" :open="hasAdvancedFilters">/, 'Advanced filters must be collapsed by default and open only when active filters require visibility.')
