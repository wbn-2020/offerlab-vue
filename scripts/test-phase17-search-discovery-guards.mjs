...
has(searchView, /<details class="filter-details">/, 'Advanced filters must be collapsed by default without overlaying results.')
...
has(knowledgeExploreView, /高级：查看关系依据/, 'KnowledgeExploreView must keep relation evidence behind an advanced disclosure.')
has(knowledgeExploreView, /相关公开内容[\s\S]*推荐阅读顺序[\s\S]*待补充主题/, 'KnowledgeExploreView primary modules must use reader-facing language.')
