...
has(operationSlotCard, /slot\.value\?\.degraded \|\| \(slot\.value && slot\.value\.source !== 'remote'\)\) return 'DEGRADED'/, 'Public operation slot fallback must translate internal example/fallback labels into a safe degraded state.')
