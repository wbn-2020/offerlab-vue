...
assert.match(editor, /isLowQualityVisibleText/, 'editor must detect mojibake-like draft labels')
assert.match(editor, /questionMarks >= 2/, 'editor must reject question-mark-heavy corrupted draft labels')
