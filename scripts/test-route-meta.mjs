...
const adminRouteAccess = {
  ...
  '/admin/collaboration': { ops: true, questionOperator: false, contentModerator: true, domainModerator: true, admin: true },
  '/admin/collaboration/insights': { ops: false, questionOperator: false, contentModerator: true, domainModerator: true, admin: true },
  ...
  '/admin/community-health/quality-governance-analytics': { ops: false, questionOperator: false, contentModerator: true, domainModerator: true, admin: true },
  '/admin/community-health/playbooks': { ops: true, questionOperator: false, contentModerator: true, domainModerator: true, admin: true },
