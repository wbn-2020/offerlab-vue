...
assert.match(view, /优先刷这些/, 'CompanyPrepView must render a personal recommendation section')
...
assert.match(view, /暂无待推荐题/, 'CompanyPrepView must include an empty state for fully prepared companies')
...
assert.match(exporter, /## 优先刷这些/, 'Company prep Markdown export must include a personal recommendation section')
