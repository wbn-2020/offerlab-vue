...
const criticalRoutes = [
  ...
  { path: '/companies/:company/prep', view: 'LegacyTrainingUnavailableView.vue' },
  { path: '/me/prep', view: 'LegacyTrainingUnavailableView.vue' },
  { path: '/me/settings', view: 'SettingsView.vue' },
  { path: '/mock-interview', view: 'LegacyTrainingUnavailableView.vue' },
