      ...
      <template v-else-if="officeHour">
        <section class="detail-hero">
          ...
          <div class="action-bar">
            <RouterLink :to="collaborationHubLocation('office-hours')" class="primary-button">
              <CalendarCheck2 class="icon" aria-hidden="true" />
              回到预约工作台
            </RouterLink>
            <RouterLink v-if="officeHour.canManage" :to="collaborationHubLocation('manage')" class="secondary-button">
          ...
          <div class="main-column">
            <section class="content-section">
              <div class="section-heading">
                <div>
                  <span class="section-kicker">OFFICE HOUR BRIEF</span>
                  <h2>交流说明</h2>
                </div>
            ...
            <section class="content-section">
              <div class="section-heading">
                <div>
                  <span class="section-kicker">TOPIC GUIDANCE</span>
                  <h2>提问指引</h2>
                </div>
