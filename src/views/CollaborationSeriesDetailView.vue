      ...
      <template v-else-if="series">
        <section class="detail-hero">
          ...
          <div class="action-bar">
            <RouterLink :to="collaborationHubLocation('series')" class="primary-button">
              <Send class="icon" aria-hidden="true" />
              前往投稿工作台
            </RouterLink>
            <RouterLink v-if="series.canManage" :to="collaborationHubLocation('manage')" class="secondary-button">
          ...
          <div class="main-column">
            <section class="content-section">
              <div class="section-heading">
                <div>
                  <span class="section-kicker">COLLABORATION BRIEF</span>
                  <h2>合集说明</h2>
                </div>
