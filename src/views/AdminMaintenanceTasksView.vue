...
const priorityLabel = (value: MaintenancePriority) => ({ LOW: '低优先级', MEDIUM: '中优先级', HIGH: '高优先级' }[value])
...
<style scoped>
.admin-maintenance-page{background: var(--surface-soft)}.page-header,.queue-head,.task-head,.review-bar,.reassign-bar{display:flex;align-items:flex-start;justify-content:space-between;gap:1rem}.page-header{margin-bottom:1.25rem}.page-header p{margin:0;color: rgb(26 127 90);font-size:.75rem;font-weight:900}.page-header h1{margin:.2rem 0;color: var(--text-strong);font-size:1.5rem;font-weight:900}.page-header span{color: var(--text-muted);font-size:.85rem;line-height:1.55}.icon-button{display:inline-flex;width:2.5rem;height:2.5rem;align-items:center;justify-content:center;border: 1px solid var(--border-subtle);border-radius:.5rem;background:white}.layout{display:grid;grid-template-columns:minmax(17rem,22rem) minmax(0,1fr);gap:1rem;align-items:start}.create-panel,.queue-panel{border: 1px solid var(--border-subtle);border-radius:.625rem;background:white;padding:1rem}.create-panel{position:sticky;top:5rem}.create-panel h2,.queue-head h2,.task-head h3{margin:0;color: var(--text-strong);font-size:1rem;font-weight:900}.queue-head p{margin:.3rem 0 0;color: var(--text-muted);font-size:.76rem;line-height:1.5}.form-stack{display:grid;gap:.65rem;margin-top:1rem}.field-group{display:grid;gap:.3rem}.field-label{color: var(--text-primary);font-size:.72rem;font-weight:800}.field-control{width:100%;min-width:0;border: 1px solid var(--border-subtle);border-radius:.5rem;background:white;padding:.58rem .65rem;color: var(--text-strong);font-size:.78rem}.filters{display:flex;flex-wrap:wrap;gap:.5rem}.compact{width:auto;min-width:8rem}.task-list{display:grid;gap:.75rem;margin-top:1rem}.task-row{border-top: 1px solid var(--border-subtle);padding-top:.85rem}.task-row:first-child{border-top:0;padding-top:0}.badge-line{display:flex;flex-wrap:wrap;gap:.4rem}.status,.source,.priority{display:inline-flex;border-radius:999px;padding:.2rem .5rem;font-size:.66rem;font-weight:900}.status-active{background: rgb(205 232 220);color: rgb(18 99 74)}.status-warn{background: rgb(254 243 199);color: rgb(146 64 14)}.status-ok{background: rgb(220 252 231);color: rgb(21 128 61)}.status-muted,.source{background: var(--surface-soft);color: var(--text-primary)}.priority-high{background: rgb(254 226 226);color: rgb(185 28 28)}.priority-medium{background: rgb(254 243 199);color: rgb(146 64 14)}.priority-low{background: rgb(220 252 231);color: rgb(21 128 61)}.task-head h3{margin-top:.5rem}.task-row p,.task-row small{display:block;margin:.55rem 0 0;color: var(--text-primary);font-size:.78rem;line-height:1.55}.task-row small{color: var(--text-muted);font-size:.7rem}.due-meta{font-size:.72rem!important}.due-neutral{color: var(--text-primary)!important}.due-overdue{color: rgb(185 28 28)!important;font-weight:900}.open-link{color: rgb(26 127 90);font-size:.72rem;font-weight:800;white-space:nowrap}.note{border-left: 2px solid rgb(124 195 165);padding-left:.6rem}.review-bar,.reassign-bar{align-items:center;margin-top:.75rem}.review-bar{display:grid;grid-template-columns:minmax(13rem,1fr) repeat(3,auto);align-items:end}.review-note{min-height:76px;resize:vertical}.decision-actions{display:flex;align-items:center;gap:.45rem}.review-bar .field-control,.reassign-bar .field-control:not(.compact){flex:1}.load-more-row{display:flex;justify-content:center;margin-top:1rem}.primary-button,.secondary-button,.danger-button{display:inline-flex;min-height:38px;align-items:center;justify-content:center;border-radius:.5rem;padding:.45rem .7rem;font-size:.76rem;font-weight:900}.primary-button{border: 1px solid rgb(18 99 74);background: rgb(18 99 74);color:white}.secondary-button{border: 1px solid var(--border-subtle);background:white;color: var(--text-primary)}.danger-button{border: 1px solid rgb(220 38 38);background: rgb(254 242 242);color: rgb(185 28 28)}button:disabled{cursor:not-allowed;opacity:.5}.state{border: 1px dashed var(--border-subtle);border-radius:.625rem;background:white;padding:2rem;color: var(--text-muted);text-align:center}.state p{margin:0}.state .secondary-button{margin-top:.75rem}.state-error{border-style:solid;border-color: rgb(254 202 202);color: rgb(185 28 28)}.load-more-error{margin-top:1rem;padding:1rem}@media(max-width:900px){.layout{grid-template-columns:1fr}.create-panel{position:static}.review-bar{grid-template-columns:1fr}.decision-actions{justify-content:space-between}}@media(max-width:650px){.page-header,.queue-head,.task-head,.reassign-bar{flex-direction:column}.compact{width:100%}.decision-actions{width:100%;flex-direction:column;align-items:stretch}}.dark .admin-maintenance-page{background: var(--surface-1)}.dark .create-panel,.dark .queue-panel,.dark .field-control,.dark .secondary-button,.dark .icon-button,.dark .state{border-color: var(--border-subtle);background: var(--surface-1);color: var(--text-muted)}.dark .page-header h1,.dark .create-panel h2,.dark .queue-head h2,.dark .task-head h3{color: var(--text-strong)}.dark .page-header span,.dark .queue-head p,.dark .task-row p,.dark .task-row small,.dark .field-label{color: var(--text-muted)}.dark .task-row{border-color: var(--border-subtle)}
</style>
