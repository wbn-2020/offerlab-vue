...
<style scoped>
.analytics-page { background: var(--surface-soft); }
...
.page-header { margin-bottom: 1.25rem; }.page-header p, .section-heading p { margin: 0; color: rgb(26 127 90); font-size: .72rem; font-weight: 900; }.page-header h1 { margin: .2rem 0; color: var(--text-strong); font-size: 1.5rem; font-weight: 900; }.page-header span { color: var(--text-muted); font-size: .82rem; }.icon-button { display: inline-flex; width: 2.5rem; height: 2.5rem; align-items: center; justify-content: center; border: 1px solid var(--border-subtle); border-radius: .5rem; background: white; color: var(--text-primary); }.icon-button:disabled,.secondary-button:disabled { cursor: not-allowed; opacity: .55; }
.filter-bar { display: grid; grid-template-columns: repeat(6, minmax(0, 1fr)); gap: .7rem; margin-bottom: 1rem; padding-bottom: 1rem; border-bottom: 1px solid var(--border-subtle); }.filter-bar label,.inline-controls label,.inline-select { display: grid; min-width: 0; gap: .3rem; color: var(--text-primary); font-size: .68rem; font-weight: 850; }.filter-bar input,.filter-bar select,.inline-controls select,.inline-select select { width: 100%; min-width: 0; height: 2.25rem; border: 1px solid var(--border-subtle); border-radius: .45rem; background: white; padding: 0 .55rem; color: var(--text-strong); font-size: .76rem; }
.projection-state { margin-bottom: 1rem; border: 1px solid rgb(169 216 195); border-radius: .55rem; background: rgb(232 243 237); padding: .75rem .85rem; color: rgb(10 52 39); }.projection-state div { display: grid; gap: .15rem; }.projection-state strong { font-size: .82rem; }.projection-state span,.projection-state small { font-size: .72rem; line-height: 1.5; }.projection-state small { white-space: nowrap; }.projection-state--degraded,.projection-state--stale,.projection-state--rebuilding { border-color: rgb(253 230 138); background: rgb(255 251 235); color: rgb(146 64 14); }.projection-state--failed,.projection-state--unavailable { border-color: rgb(254 202 202); background: rgb(254 242 242); color: rgb(185 28 28); }
.watermark-strip { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: .6rem; margin-bottom: 1.3rem; }.watermark-item { display: grid; min-width: 0; gap: .18rem; border-top: 2px solid rgb(33 154 112); padding: .5rem 0; }.watermark-item strong { color: var(--text-strong); font-size: .72rem; }.watermark-item span { overflow: hidden; color: var(--text-primary); font-size: .72rem; text-overflow: ellipsis; white-space: nowrap; }.watermark-item small { color: var(--text-muted); font-size: .65rem; line-height: 1.45; }
.state { display: grid; justify-items: center; gap: .65rem; border: 1px dashed var(--border-subtle); border-radius: .55rem; background: white; padding: 2rem 1rem; color: var(--text-muted); font-size: .82rem; text-align: center; }.state p { margin: 0; }.state-error { border-style: solid; border-color: rgb(254 202 202); color: rgb(185 28 28); }.secondary-button { min-height: 2rem; border: 1px solid var(--border-subtle); border-radius: .45rem; background: white; padding: 0 .65rem; color: var(--text-primary); font-size: .72rem; font-weight: 850; }
.section-block { margin-top: 1.7rem; border-top: 1px solid var(--border-subtle); padding-top: 1rem; }.section-heading { align-items: end; margin-bottom: .75rem; }.section-heading h2 { margin: .18rem 0 0; color: var(--text-strong); font-size: 1rem; font-weight: 900; }.section-heading > small { color: var(--text-muted); font-size: .68rem; text-align: right; }.funnel-grid,.rate-grid { display: grid; grid-template-columns: repeat(6, minmax(0, 1fr)); gap: .6rem; }.metric-card { display: grid; min-width: 0; gap: .55rem; border: 1px solid var(--border-subtle); border-radius: .5rem; background: white; padding: .75rem; }.metric-card__head { gap: .45rem; color: var(--text-primary); font-size: .69rem; font-weight: 850; }.metric-card > strong { overflow: hidden; color: var(--text-strong); font-size: 1.1rem; font-weight: 900; text-overflow: ellipsis; white-space: nowrap; }.metric-card > small { min-height: 2.8em; color: var(--text-muted); font-size: .64rem; line-height: 1.45; }
.availability { display: inline-flex; width: fit-content; border-radius: 999px; padding: .14rem .4rem; font-size: .6rem; font-weight: 900; white-space: nowrap; }.availability--available { background: rgb(220 252 231); color: rgb(22 101 52); }.availability--unavailable { background: rgb(254 226 226); color: rgb(185 28 28); }.availability--suppressed { background: rgb(237 233 254); color: rgb(109 40 217); }.availability--no_eligible_sample { background: var(--surface-soft); color: var(--text-primary); }
.duration-grid { display: grid; gap: .55rem; }.duration-row { display: grid; grid-template-columns: minmax(10rem, .7fr) minmax(0, 2fr) minmax(12rem, .8fr); align-items: center; gap: 1rem; border-bottom: 1px solid var(--border-subtle); padding: .7rem .1rem; }.duration-row > div { align-items: center; }.duration-row > div strong { color: var(--text-strong); font-size: .75rem; }.duration-row dl { display: grid; grid-template-columns: repeat(4, minmax(0, 1fr)); gap: .5rem; margin: 0; }.duration-row dt { color: var(--text-muted); font-size: .62rem; }.duration-row dd { overflow: hidden; margin: .16rem 0 0; color: var(--text-strong); font-size: .74rem; font-weight: 850; text-overflow: ellipsis; white-space: nowrap; }.duration-row > small { color: var(--text-muted); font-size: .64rem; line-height: 1.45; }.rate-grid { grid-template-columns: repeat(3, minmax(0, 1fr)); }
.inline-controls { display: flex; flex-wrap: wrap; justify-content: flex-end; gap: .55rem; }.inline-controls label { width: 10rem; }.inline-select { width: 10.5rem; }.trend-panel { border: 1px solid var(--border-subtle); border-radius: .5rem; background: white; padding: .8rem; }.trend-chart { height: 12rem; }.trend-chart svg { width: 100%; height: 100%; overflow: visible; }.trend-axis { stroke: var(--border-subtle); stroke-width: .55; }.trend-line { stroke: rgb(26 127 90); stroke-width: 1.25; vector-effect: non-scaling-stroke; }.trend-point { fill: rgb(26 127 90); }.trend-buckets { display: grid; grid-template-columns: repeat(auto-fit, minmax(8.5rem, 1fr)); gap: .45rem; margin: .7rem 0 0; padding: 0; list-style: none; }.trend-buckets li { display: grid; min-width: 0; gap: .25rem; border-top: 1px solid var(--border-subtle); padding-top: .45rem; }.trend-buckets strong { color: var(--text-primary); font-size: .67rem; }.trend-buckets b { color: var(--text-strong); font-size: .76rem; }.trend-buckets small { color: var(--text-muted); font-size: .62rem; line-height: 1.4; }.chart-empty { border: 1px dashed var(--border-subtle); border-radius: .45rem; padding: 1rem; color: var(--text-muted); font-size: .74rem; text-align: center; }
.breakdown-table { border: 1px solid var(--border-subtle); border-radius: .5rem; overflow: hidden; }.breakdown-table__head,.breakdown-table__row { display: grid; grid-template-columns: minmax(9rem, 1.2fr) minmax(6rem, .8fr) minmax(6rem, .65fr) minmax(5rem, .55fr) minmax(10rem, 1.2fr); gap: .75rem; align-items: center; padding: .6rem .75rem; }.breakdown-table__head { background: var(--surface-soft); color: var(--text-muted); font-size: .65rem; font-weight: 850; }.breakdown-table__row { border-top: 1px solid var(--border-subtle); color: var(--text-primary); font-size: .71rem; }.breakdown-table__row strong { overflow: hidden; color: var(--text-strong); text-overflow: ellipsis; white-space: nowrap; }.breakdown-table__row small { color: var(--text-muted); font-size: .64rem; line-height: 1.4; }
...
.dark .analytics-page { background: var(--surface-1); }.dark .page-header h1,.dark .section-heading h2,.dark .metric-card > strong,.dark .duration-row > div strong,.dark .duration-row dd,.dark .trend-buckets b,.dark .breakdown-table__row strong { color: var(--text-strong); }.dark .page-header span,.dark .watermark-item small,.dark .metric-card > small,.dark .duration-row > small,.dark .trend-buckets small,.dark .breakdown-table__row small { color: var(--text-muted); }.dark .filter-bar,.dark .section-block,.dark .duration-row,.dark .trend-buckets li,.dark .breakdown-table__row { border-color: var(--border-subtle); }.dark .filter-bar input,.dark .filter-bar select,.dark .inline-controls select,.dark .inline-select select,.dark .icon-button,.dark .secondary-button,.dark .metric-card,.dark .trend-panel,.dark .breakdown-table { border-color: var(--border-subtle); background: var(--surface-1); color: var(--text-muted); }.dark .watermark-item strong,.dark .watermark-item span,.dark .metric-card__head,.dark .duration-row dt,.dark .trend-buckets strong,.dark .breakdown-table__row { color: var(--text-muted); }.dark .breakdown-table__head { background: var(--surface-1); color: var(--text-muted); }.dark .chart-empty,.dark .state { border-color: var(--border-subtle); background: var(--surface-1); color: var(--text-muted); }.dark .trend-axis { stroke: rgb(45 65 55); }
</style>
